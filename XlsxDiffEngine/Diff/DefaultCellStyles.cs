...
public static class DefaultCellStyles
{
    ...
    /// </summary>
    public static readonly CellStyle AddedRow = new() { BackgroundColor = Color.FromArgb(175, 255, 175) };
    ...
    /// </summary>
    public static readonly CellStyle ChangedCell = new() { BackgroundColor = Color.FromArgb(255, 180, 100) };
    ...
    /// </summary>
    public static readonly CellStyle YellowValueChangedMarker = new() { BackgroundColor = Color.FromArgb(254, 255, 100) };

    /// <summary>
    /// Represents an orange marker style for cells with changed values, with a light orange background.
    /// </summary>
    public static readonly CellStyle OrangeValueChangedMarker = new() { BackgroundColor = Color.FromArgb(255, 150, 100) };

    /// <summary>
    /// Represents a red marker style for cells with significant value changes, with a light red background.
    /// </summary>
    public static readonly CellStyle RedValueChangedMarker = new() { BackgroundColor = Color.FromArgb(255, 100, 100) };

    /// <summary>
    /// Represents a style for cells with non-original fallback values.
    /// </summary>
    public static readonly CellStyle FallbackValue = new() { Strike = true };
}
